...
<head>
  ...
  <meta property="og:description" content="Portfolio : Site présentant les projets sur lesquels je travaille. Réalisé en HTML5, CSS3, Bootstrap et une toute petite pincée de JS.">
...
<body>
    ...
    <header>
        ...
        <span class="text-animation">
            <span class="letters">Développeur Front-End</span>
        </span>
        </h1>
        <h2 class="center">Projects Timeline</h2>
</div>
    </section>
    <section>
